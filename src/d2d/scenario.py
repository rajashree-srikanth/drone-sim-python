...
class ScenLinePatrol:
    ...
    desc = "Line Patrol"
    def __init__(self):
        traj1 = ddtf.TrajLineWithIntro(Y0=[0., 100.], Y1=[0., 50.], Y2=[200., 50.])
        
        #traj2 = ddt.TrajectoryCircle(c=[45., 50.], dalpha=np.deg2rad(30.))
        #Y0, Y1, Y2 = [0,0], [200, 200], [400, 0]
        #traj2 = ddt.TrajectoryLine(Y0, Y1, v=10., t0=0.)
        traj2 = ddtf.TrajLineWithIntro(Y0=[0., 0.], Y1=[0., 50.], Y2=[200., 50.])

        self.trajs = [traj1, traj2]
        self.X0s = [[75, 50, np.pi/2, 0, 10], [85, 70, np.pi/1.5, 0, 10]]
        self.extends = (-30, 230, -10, 110) # _xmin, _xmax, _ymin, _ymax
