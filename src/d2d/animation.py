...
def animate(time, Xs=None, U=None, Xref=None, Yrefs=None, title=None, _drawings=False, _imgs=True, figure=None, ax=None, extends=None):
    ...
    def init():
        ...
        return [time_text] + marker_acs + marker_refs
