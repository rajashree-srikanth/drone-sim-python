...
phase 2 - formation goal -> square + tracking to get to final formation
        ...
        - optimization computation time is moderate (approx. 1.2 s)
...
def main():
    ...
    #### phase 1 of flight ####
    print(t_end_1)
    X_array_1, U_array_1, U1_1, U2_1, Ur_1, e_theta_arr_1, time_1, t1_f = CircularFormationGVF(c, r, v, n_ac, t_start, t_step, t_end_1)
